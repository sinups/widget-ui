...
const Launcher = ({ fill, size }) => (
  <svg width={size} height={size} viewBox="0 0 30 30" preserveAspectRatio="xMidYMid meet" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
const RightArrow = ({ fill, size }) => (
  <svg width={size} height={size} viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg">
...
const Emoji = ({ fill, size }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill={fill}>
    <g fillRule="evenodd">
...
Check.propTypes = iconStandardProps
...
const Icon = ({ name, fill, size }) => {
  switch (name) {
    ...
    case 'check':
      return <Check fill={fill} size={size} />
    default:
      break
  }
}
